...
('Game Boy Color', 'Console portátil, edição translúcida, funciona perfeitamente.', 'GameBoy', 699.90, 2, 'gameboy_color.jpg'),
('Cartucho Pokémon Yellow', 'Aventura clássica de Pokémon.', 'GameBoy', 299.90, 4, 'pokemon_yellow.jpg'),
